...
\end{equation}
其中$T_{ref,i}$取各电场历史振打周期中位数，作为基准运行点；$r=0.5$为过频振打副作用占比，反映振打过频导致二次扬尘增加的效应。当$T_i=T_{ref,i}$时$d_i=0$，衰减项为$1$（效率最高）；$T_i$偏离$T_{ref,i}$越远（无论方向），效率越低。$\alpha_i$为振打衰减系数。合并后单级效率完整形式为：
\begin{equation}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{CCCCCC}
    ...
    $\alpha_i$ & 0.0023 & 0.0021 & 0.001 & 0.001 & 下界$0.001$ \\
