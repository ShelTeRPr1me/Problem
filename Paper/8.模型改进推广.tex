...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\textwidth]{figures/pareto_front.png}
...
（4）\textbf{推广至其他除尘设备。}Deutsch方程框架可推广至袋式除尘器（将驱进速度替换为过滤风速）或其他工业ESP（钢铁、火电），仅需重新拟合参数。\footnote{AI辅助润色}
